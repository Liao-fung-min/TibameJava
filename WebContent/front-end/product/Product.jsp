				 ...
				 <!--數量 -->
					...
					<div id="product_select2">
						...
						<div class="row justify-content-center">
                            ...
                            <div class="col-sm-12 col-md-4" style="margin-top: 20px; ">
                                <a href="#" class="btn btn-primary stretched-link" id="shoppingcart"> 購物車 </a>
                            </div>
                            
                            <div class="col-sm-12 col-md-4" style="margin-top: 20px; ">
                            
                                <a href="<%=request.getContextPath()%>/front-end/product/ShoppingCart.jsp" class="btn btn-primary stretched-link" id="buy">直接購買</a>
