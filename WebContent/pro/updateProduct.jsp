...
<table id="table-1">
	<tr><td>
		 <h3>產品資料修改 - update_product_input.jsp</h3>
		 <h4><a href="<%=request.getContextPath()%>/product_page.jsp"><img src="pro/images/cat.png" width="100" height="32" border="0"/>回首頁</a></h4>
	</td></tr>
</table>
		...
		<table>
			...
			<tr>
				...
				<td><input type="TEXT" name="name" size="45"
					value="<%=(product_VO == null) ? "請輸入產品名稱" : product_VO.getName()%>" /></td>
			</tr>
			<tr>
				<td>商品類別:</td>
