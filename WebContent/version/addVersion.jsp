...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>規格新增 - addVersion.jsp</h3>
			</td>
			<td>
				<h4>
					<a href="<%=request.getContextPath()%>/version_page.jsp"><img src="/pro/images/cat.png" width="100" height="100" border="0">回首頁</a>
				</h4>
			</td>
		</tr>
	</table>
		...
		<table>
			<tr>
				...
				<td><input type="TEXT" name="product_id" size="45"
					value="<%=(version_VO == null) ? "" : version_VO.getProduct_id()%>" placeholder="請輸入產品編號"/></td>
			</tr>
			<tr>
				<td>規格名稱:</td>
				<td><input type="TEXT" name="version_name" size="45"
					value="<%=(version_VO == null) ? "" : version_VO.getVersion_name()%>" placeholder="請輸入規格名稱"/></td>
			</tr>
			<tr>
				<td>價錢:</td>
				<td><input type="TEXT" name="price" size="45"
					value="<%=(version_VO == null) ? "" : version_VO.getPrice()%>" placeholder="請輸入價錢"/></td>
			</tr>
			<tr>
				<td>數量:</td>
				<td><input type="TEXT" name="inventory" size="45"
					value="<%=(version_VO == null) ? "" : version_VO.getInventory()%>" placeholder="請輸入數量"/></td>
			</tr>
